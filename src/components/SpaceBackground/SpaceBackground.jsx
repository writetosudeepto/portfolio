...
function MinecraftBlock({ position = [0, 0, 0], speed = 0.1, size = 0.2, blockType = 'stone' }) {
  ...
  const blockColors = {
    ...
    light: {
      stone: '#4a4a4a',      // Darker gray
      cobblestone: '#3a3a3a', // Very dark gray
      dirt: '#5d4209',       // Darker brown
      grass: '#2d5c1f',      // Dark green
      diamond: '#1565c0',    // Dark blue
      emerald: '#00695c',    // Dark teal
      iron: '#616161',       // Dark gray
      gold: '#e65100'        // Dark orange
    },
  ...
  const trailColor = isDarkMode ? '#4dd0e1' : '#1565c0';
...
function CustomStars({ count = 200 }) {
  ...
  const starOpacity = isDarkMode ? 0.6 : 0.8;
